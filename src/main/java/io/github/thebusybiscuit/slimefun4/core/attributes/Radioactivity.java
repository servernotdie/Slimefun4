...
public enum Radioactivity {
     ...
     */
    VERY_DEADLY(ChatColor.DARK_RED, "Chết chóc", 10);
    ...
    public @Nonnull String getLore() {
        return ChatColor.GREEN + "\u2622" + ChatColor.GRAY + " Mức phóng xạ: " + color + displayName;
    }
